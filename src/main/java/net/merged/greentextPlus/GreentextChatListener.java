...
public class GreentextChatListener implements Listener {
	...
	public void onPlayerChat(AsyncChatEvent e) {
		...
		message = message.replaceText(
				TextReplacementConfig.builder().replacement("\u2620").match(Pattern.quote(":skull:")).build());
		message = message.replaceText(
				TextReplacementConfig.builder().replacement("shitskin").match(Pattern.quote("aryan")).build());
		message = message.replaceText(
				TextReplacementConfig.builder().replacement("SHITSKIN").match(Pattern.quote("ARYAN")).build());
